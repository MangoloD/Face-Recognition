...
if __name__ == '__main__':
    index = 9
    params_path = "Data/Params_2/R"
    max_params_path = "Data/Params_2/R_max"
    doc_path = "Data/Params_2/R.txt"
    ...
    net = part2_nets.RNet()
    save_path = f"{params_path}/r_net"
    max_save_path = f"{max_params_path}/r_net"
    ...
    trainer.train(0.6, 1000, doc_path, True)
